...
public class ServicioCarritoTest {
	...
	public void testQueObtengaElTotalDelCarrito() {
		// Preparacion
		Curso curso1 = new Curso("Curso PHP/MySql desde 0", "programacion", "En este curso se vera como crear aplicaciones y sitios web desde cero con PHP y MYSQL.", 3000.0, "php-desde-cero.jpg");
		Curso curso2 = new Curso("Spring Framework 5", "programacion", "Construye aplicaciones web con Spring Framework 5 & Spring Boot: Thymeleaf, JPA, Security, REST, MySQL, Angular, WebFlux.", 2500.0, "curso-spring.jpg");
