...
public class ServicioPrincipalImpl implements ServicioPrincipal {
	...
	public void insertarRegistros() {
		...
		Curso c3 = new Curso("Python 2022", "programacion", "En este curso aprenderas desde las bases de Python hacia temas mÃ¡s avanzados del lenguaje.", 2600.0, Estado.EN_VENTA, "curso-phyton.jpg");
		Curso c4 = new Curso("Adobe Photoshop: Curso completo", "diseno", "Aprende las herramientas esenciales de Adobe Photoshop para comenzar a diseÃ±ar hermosos graficos y fotos en Photoshop.", 1000.0, Estado.EN_VENTA, "adobe-photoshop.jpg");
		Curso c5 = new Curso("Curso completo de WordPress", "diseno", "El Mejor Curso de WordPress para aprender desde cero... Â¡Mas de 5.000 alumnos satisfechos!", 800.0, Estado.EN_VENTA, "wordpress.jpg");
		Curso c6 = new Curso("Modelado y diseÃ±o para videojuegos", "diseno", "Aprende DESDE CERO a Modelar, Texturizar, Iluminacion y Render de modelos 2D 3D Assets Videojuegos MagicaVoxel y Unity", 3200.0, Estado.EN_VENTA, "diseÃ±o-videojuegos.jpg");
		Curso c7 = new Curso("Curso de guitarra practico para principiantes", "musica", "Aprende paso a paso a tocar la guitarra con este curso practico. Aprende tocando y olvÃ­date de ejercicios aburridos.", 1650.0, Estado.EN_VENTA, "curso-guitarra.jpg");
		Curso c8 = new Curso("Curso de piano completo", "musica", "Aprendelo Todo: Armonia , Composicion, Improvisacion , AcompaÃ±ar con acordes, Lectura & Solfeo, Tecnica y Relajacion.", 2000.0, Estado.EN_VENTA, "curso-piano.jpg");
		Curso c9 = new Curso("Curso de canto para principiantes", "musica", "Â¡Encuentra tu voz de canto de forma natural y diviÃ©rtete haciÃ©ndolo! Un enfoque moderno para las clases de canto.", 2000.0, Estado.EN_VENTA, "curso-canto.jpg");
		...
		Unidad un1 = new Unidad("Unidad 1: PresentaciÃ³n", "https://www.youtube.com/embed/I75CUdSJifw");
		Unidad un2 = new Unidad("Unidad 2: InstalaciÃ³n software del curso", "https://www.youtube.com/embed/tXxOAXP-gkg");
		Unidad un3 = new Unidad("Unidad 3: Primera pÃ¡gina PHP", "https://www.youtube.com/embed/Ja9UVEgAzEw");
		Unidad un4 = new Unidad("Unidad 4: Variables y comentarios", "https://www.youtube.com/embed/IOdmCo_7U6s");
		
		Unidad un5 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/eyWmkbReWLI");
		Unidad un6 = new Unidad("Unidad 2: Â¿QuÃ© es Spring Boot?", "https://www.youtube.com/embed/UvXktTs2bx0");
		Unidad un7 = new Unidad("Unidad 3: InstalaciÃ³n del Spring Tools IDE", "https://www.youtube.com/embed/9yAt3hAJ-vg");
		
		Unidad un8 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/DAdRO6ByBoU");
		Unidad un9 = new Unidad("Unidad 2: EjecuciÃ³n de un programa", "https://www.youtube.com/embed/UzHFkEdnRuc");
		Unidad un10 = new Unidad("Unidad 3: Variables en Python", "https://www.youtube.com/embed/w8VZxo1TlnU");
		
		Unidad un11 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/4-VMuLs99Ss");
		Unidad un12 = new Unidad("Unidad 2: Tapon de Clonar y Parche", "https://www.youtube.com/embed/Y9yKFzACEHg");
		Unidad un13 = new Unidad("Unidad 3: Lazos y Tono/SaturaciÃ³n", "https://www.youtube.com/embed/HVBg6Fn2Rc0");
		
		Unidad un14 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/OAWTixdQjqM");
		Unidad un15 = new Unidad("Unidad 2: InstalaciÃ³n en windows", "https://www.youtube.com/embed/BbRYgUiAsEQ");
		Unidad un16 = new Unidad("Unidad 3: PÃ¡rrafos", "https://www.youtube.com/embed/48aCNffCJTU");
		
		Unidad un17 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/Vf9PyoXPkjI");
		Unidad un18 = new Unidad("Unidad 2: Ejercicios", "https://www.youtube.com/embed/hdcCtgeKHqI");
		Unidad un19 = new Unidad("Unidad 3: NavegaciÃ³n BÃ¡sica", "https://www.youtube.com/embed/HE_OXqM2ks8");
		...
		Unidad un23 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/kAALQ4JEY6c");
		...
		Unidad un26 = new Unidad("Unidad 1: IntroducciÃ³n", "https://www.youtube.com/embed/ciHP0DGppX4");
		Unidad un27 = new Unidad("Unidad 2: RespiraciÃ³n", "https://www.youtube.com/embed/utAoguWXYTc");
