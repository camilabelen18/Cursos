        ...
        <div class="cuadro-seccion-preguntas">
            ...
            <c:forEach var="itemPregunta" items="${datosExamen.datosPregunta}" varStatus="vs">
                ...
                <div class="cuadro-respuestas">
                    ...
                    <form:radiobutton path="datosPregunta[${vs.index}].respuestaElegida"
                                      value="${itemPregunta.respuesta_1.id}"/>${itemPregunta.respuesta_1.descripcion}
                    <form:radiobutton path="datosPregunta[${vs.index}].respuestaElegida"
                                      value="${itemPregunta.respuesta_2.id}"/>${itemPregunta.respuesta_2.descripcion}
                    <form:radiobutton path="datosPregunta[${vs.index}].respuestaElegida"
                                      value="${itemPregunta.respuesta_3.id}"/>${itemPregunta.respuesta_3.descripcion}
                </div>
